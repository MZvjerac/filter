                ...
                <Paper>
                    <TableContainer component={Paper} className={classes.container}>
                        {(props.data && props.data.length !== 0)
                            ...
                            : <div style={{ marginTop:"55px" }}><p style={{ color:"red", fontSize:"18px" }}>There are no results for your search. Please reset Your search or enter new search term/s. </p></div>
                        }
                    </TableContainer>
                </Paper>
            </Grid>
